...
return [
    ...
    */
    ...
    'project_logo'   => env('APP_PROJECT_LOGO', '<img src="https://z1-prod-s3.s3.ap-southeast-1.amazonaws.com/assets/Zillennium-logo.png" alt="zillennium_logo">') ,
    ...
    'header_class' => 'app-header  border-0 navbar navbar-color  '. env('APP_HEADER_CLASS', 'bg-primary'),
    ...
    'sidebar_class' => 'sidebar '. env('APP_SIDEBAR_CLASS', ''),
